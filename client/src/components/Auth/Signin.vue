  ...
  data(){
    return{
      ...
      usernameRules: [
        ...
        username => !!username || 'O nome do usuário é requerido!',
        // make sure if username is less than 10 characters
        username => username.length < 10 || 'O usuário deve ter menos que 10 caracteres'
      ],
      passwordRules: [
